...
public class Nivel3_4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel34);
    ...
    public void openSiguienteActivity(){
        Intent intent = new Intent(this, Nivel3_5Activity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(Nivel3_4Activity.this);
