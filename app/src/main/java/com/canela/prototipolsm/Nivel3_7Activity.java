...
public class Nivel3_7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel37);
    ...
    public void openSiguienteActivity(){
        Intent intent = new Intent(this, Nivel3_8Activity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(Nivel3_7Activity.this);
