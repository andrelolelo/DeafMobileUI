...
public class NivelBActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel_bactivity);
        getSupportActionBar().setTitle("Nivel 2");

        buttonAyudaNivel = (Button) findViewById(R.id.button_ayuda_instrucciones_b);
        buttonNotaSecreta = (Button) findViewById(R.id.button_nivel_secreto_b);
     ...
     */
    public void openNivelCActivity(){
        Intent intent = new Intent(this, NivelCActivity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(NivelBActivity.this);
