...
public class NivelAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel_aactivity);
        getSupportActionBar().setTitle("Nivel 2");

        buttonAyudaNivel = (Button) findViewById(R.id.button_ayuda_instrucciones_a);
        buttonNotaSecreta = (Button) findViewById(R.id.button_nivel_secreto_a);
     ...
     */
    public void openNivelBActivity(){
        Intent intent = new Intent(this, NivelBActivity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(NivelAActivity.this);
