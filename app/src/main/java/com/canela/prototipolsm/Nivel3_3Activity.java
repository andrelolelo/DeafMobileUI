...
public class Nivel3_3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel33);
    ...
    public void openSiguienteActivity(){
        Intent intent = new Intent(this, Nivel3_4Activity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(Nivel3_3Activity.this);
