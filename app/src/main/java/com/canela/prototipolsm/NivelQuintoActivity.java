...
public class NivelQuintoActivity extends AppCompatActivity {

    VideoView videoView;

    Button buttonAyudaNivel5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel_quinto);
        getSupportActionBar().setTitle("Nivel 1");

        buttonAyudaNivel5 = (Button) findViewById(R.id.button_ayuda_instruccionesquinto);
        buttonNotaSecreta = (Button) findViewById(R.id.button_nivelquinto_secreto);
        ...
        buttonAyudaNivel5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openInstrucciones();
            }
    ...
    public void openNivel6Activity(){
        Intent intent = new Intent(this, Nivel6Activity.class);
        startActivity(intent);
    }

    public void openInstrucciones(){
        final Dialog dialog = new Dialog(NivelQuintoActivity.this);
