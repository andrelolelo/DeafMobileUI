...
public class NivelEActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel_eactivity);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(NivelEActivity.this);
