...
public class NivelDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel_dactivity);
        getSupportActionBar().setTitle("Nivel 2");

        buttonAyudaNivel = (Button) findViewById(R.id.button_ayuda_instrucciones_d);
        buttonNotaSecreta = (Button) findViewById(R.id.button_nivel_secreto_d);
     ...
     */
    public void openNivelEActivity(){
        Intent intent = new Intent(this, NivelXActivity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(NivelDActivity.this);
