...
public class Nivel3_8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel38);
    ...
    public void openSiguienteActivity(){
        Intent intent = new Intent(this, Nivel3_9Activity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(Nivel3_8Activity.this);
