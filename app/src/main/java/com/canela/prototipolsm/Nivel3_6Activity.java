...
public class Nivel3_6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel36);
    ...
    public void openSiguienteActivity(){
        Intent intent = new Intent(this, Nivel3_7Activity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(Nivel3_6Activity.this);
