...
public class Nivel3_5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel35);
    ...
    public void openSiguienteActivity(){
        Intent intent = new Intent(this, Nivel3_6Activity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(Nivel3_5Activity.this);
