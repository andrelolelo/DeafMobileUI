...
public class Nivel3_1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nivel31);
    ...
    public void openSiguienteActivity(){
        Intent intent = new Intent(this, Nivel3_2Activity.class);
    ...
    public void openInstrucciones(){
        final Dialog dialog = new Dialog(Nivel3_1Activity.this);
