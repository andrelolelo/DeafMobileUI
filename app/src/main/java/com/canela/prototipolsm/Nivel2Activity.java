...
public class Nivel2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAyudaNivel2 = (Button) findViewById(R.id.button_ayuda_instrucciones2);
        buttonNotaSecreta = (Button) findViewById(R.id.button_nivel2_secreto);
        ...
        buttonAyudaNivel2 .setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openInstrucciones();
            }
